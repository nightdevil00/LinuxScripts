            ...
            4)
                ...
                case "$bl_r" in
                    ...
                    2)
                        ...
                        arch-chroot /mnt bash -c "mkdir -p /boot/EFI/limine && cp /usr/share/limine/BOOTX64.EFI /boot/EFI/limine/ && cp /usr/share/limine/limine.sys /boot/ && efibootmgr --create --disk $DISK --part $efi_num --label 'Arch Linux' --loader '\\EFI\\limine\\BOOTX64.EFI' --unicode"
