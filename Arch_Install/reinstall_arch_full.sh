...
mkfs.fat -F32 DISKp1
mkfs.ext4 -F DISKp2  # Recovery partition
mkfs.ext4 -F DISKp3  # Root partition
...
mkdir -p /boot/efi
mount DISKp1 /boot/efi
grub-install --target=x86_64-efi --efi-directory=/boot/efi --bootloader-id=GRUB

UUID_RECOVERY=\$(blkid -s UUID -o value DISKp2)
